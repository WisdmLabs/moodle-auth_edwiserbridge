...
class edwiserbridge_sso_form extends moodleform {
    ...
    public function save_logo_file($formdata){
        global $CFG;
        $mform = $this->_form;
        $formdata->save_file('wploginbtnicon', $CFG->dirroot . '/auth/edwiserbridge/pix/wploginbtnicon.png', true);
        if ($success) {
            set_config('wploginbtnicon', 'wploginbtnicon.png', 'auth_edwiserbridge');
        }
    }
}